          ...
          <div class="container-fluid d-flex justify-content-center align-items-center pt-5">
            ...
            <div class="shadow card" style="width: 900px">
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between" style="background-color: #4767a6">
                <h6 class="m-0 font-weight-bold text-light">Form Data Warga</h6>
              </div>
              <form action="kirimdata.php" method="post">
                <div class="card-body text-dark">
                  <div class="row mb-3">
                    <label for="colFormLabelLg" class="col-sm-2 col-form-label">Nama</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="Nama" />
                    </div>
                  </div>
                  <div class="row mb-3">
                  <label for="colFormLabelLg" class="col-sm-2 col-form-label">Tempat/Tanggal Lahir</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="lahir" />
                  </div>
                </div>
                  <div class="row mb-3">
                    <label for="colFormLabelLg" class="col-sm-2 col-form-label">Alamat</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="Alamat" />
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="colFormLabelLg" class="col-sm-2 col-form-label">Jenis Kelamin</label>
                    <div class="col-sm-10">
                  ...
                  <div class="row mb-3">
                    <label for="colFormLabelLg" class="col-sm-2 col-form-label">Agama</label>
                    <div class="col-sm-10">
                  ...
                  <div class="row mb-3">
                    <label for="colFormLabelLg" class="col-sm-2 col-form-label">Status</label>
                    <div class="col-sm-10">
                  ...
                  <div class="row mb-2">
                    <label for="colFormLabelLg" class="col-sm-2 col-form-label">Kewarganegaraan</label>
                    <div class="col-sm-10">
